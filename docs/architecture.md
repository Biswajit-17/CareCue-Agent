...
10. **AgentCore deployment** - deployed agent runs the same tools via Bedrock Claude Haiku on AWS, invoked via `agentcore invoke` or API endpoint; local dev uses OpenRouter Nemotron 3 Super
